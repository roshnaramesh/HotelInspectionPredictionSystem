...
public class ReviewListExtraction {
    ...
    private static final String FILE_HEADER2 = "review_id	date	title	content	author";
    ...
    public static void main( String args[] ) throws JSONException {
        ...
        try {
        	List reviewList=new ArrayList<String>();
          ...
          /*  for(File file : files){
                if(file.isFile()){*/
                    ...
                    File file1=new File("/Users/roshnaramesh/Downloads/json/100407.json");
                    ...
                    fileWriter = new FileWriter("/Users/roshnaramesh/Downloads/json/"+fileReview+".txt");
